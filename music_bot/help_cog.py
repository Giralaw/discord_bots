...
{self.bot.command_prefix}pause - pause the current song being played or resumes if already paused
{self.bot.command_prefix}resume - resume playing the current song
{self.bot.command_prefix}prefix - change command prefix
{self.bot.command_prefix}remove - remove last song from the queue
```
"""
